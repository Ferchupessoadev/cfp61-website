...
<body>
	...
	<section class="flex justify-center items-center h-screen w-full bg-[linear-gradient(to_right,#f0f9ff,#a8c0ff)]">
	...
	<footer class="flex flex-col justify-center items-between gap-2 bg-slate-900 w-full py-5">
		<div class="flex justify-between items-center gap-2 h-40">
			<div class="flex-1 flex justify-center">
				<img class="h-16" src="/img/logo.png" alt="Centro de formación profesional de la Criolla">
			</div>
		...
		<div class="flex justify-center w-full">
			<p class="text-white flex flex-col items-center">
				<span>&copy; <?php echo date('Y'); ?> Centro de formación profesional N° 61. Todos los derechos reservados.</span>
